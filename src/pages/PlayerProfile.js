...
const FUN_FACTS = [
  ...
  "Diego Maradona's 'Hand of God' goal in 1986 was followed minutes later by what FIFA voted Goal of the Century.",
  "Ronaldo Nazário scored 8 goals at the 2002 World Cup to win the Golden Boot — eighteen months after a career-threatening knee injury.",
  "Thierry Henry never won the Ballon d'Or despite being widely considered one of the greatest forwards ever.",
  "Sir Alex Ferguson managed Manchester United for 27 years and won 13 Premier League titles.",
  "Lionel Messi has won more Ballon d'Ors than any other player — eight in total.",
  "The 1950 World Cup final between Brazil and Uruguay drew nearly 200,000 spectators at the Maracanã, still a record attendance.",
  "Roberto Carlos's free-kick goal against France in 1997 defied physics so completely that scientists studied it for years.",
  "Gianluigi Buffon played professional football for 28 years before retiring in 2023 at age 45.",
  "Cafu is the only player to appear in three consecutive World Cup finals — 1994, 1998, and 2002.",
  "Andrea Pirlo wore the number 21 because his hero, Roberto Baggio, wore it before him.",
  "Iker Casillas captained Spain to win the Euro 2008, World Cup 2010, and Euro 2012 — an unprecedented treble.",
  "Cristiano Ronaldo is the only player to win league titles in England, Spain, Italy, and Saudi Arabia.",
  "The Italian word 'catenaccio' literally means 'door bolt' — Italy's famous defensive tactic from the 1960s.",
  "Gareth Bale's bicycle kick in the 2018 Champions League final is widely considered the greatest goal in the tournament's history.",
  "Manchester City's 100-point Premier League season in 2017/18 broke a record many thought would never be touched.",
  "Leicester City won the 2015/16 Premier League at 5000-to-1 odds — bookmakers had longer odds on Elvis being alive.",
  "Sadio Mané once scored a Premier League hat-trick in 2 minutes and 56 seconds.",
  "Pelé scored his 1,000th career goal from a penalty in 1969 — the entire stadium went silent before erupting.",
  "Johan Cruyff's 'Cruyff Turn' debuted at the 1974 World Cup and has been imitated by every generation since.",
  "FC Barcelona's youth academy, La Masia, has produced more Ballon d'Or winners than most national federations.",
  "Arsenal went the entire 2003/04 Premier League season unbeaten — they're still called 'The Invincibles'.",
  "Borussia Dortmund's stadium has the largest standing terrace in European football — 'The Yellow Wall' holds 25,000 fans.",
  "Bayern Munich won every Bundesliga title from 2012/13 through 2022/23 — eleven in a row.",
  "The first FIFA World Cup, held in Uruguay in 1930, had only 13 participating teams.",
  "Italy and Brazil are the only countries to have won the World Cup on three different continents.",
  "Kaká is the last player before the Messi/Ronaldo era to win the Ballon d'Or — back in 2007.",
  "The longest official football match ever lasted 3 days and 1 hour, played in 2019 to raise charity money.",
  "The 'tiki-taka' style that defined Spain and Barcelona originated from Cruyff's philosophy at Ajax decades earlier.",
  "Roy Keane was famously sent home from the 2002 World Cup after publicly criticizing Ireland's training facilities.",
  "David Beckham scored from his own half against Wimbledon on the opening day of the 1996/97 Premier League season.",
  "Real Madrid and Barcelona's 'El Clásico' is the most-watched club football match in the world.",
  "Diego Forlán won the Golden Ball at the 2010 World Cup despite Uruguay finishing fourth.",
